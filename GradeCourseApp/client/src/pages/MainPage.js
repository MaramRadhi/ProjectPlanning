...
function MainPage() {
  ...
  var emailCookie = cookies.email;
    //checks if security level is 3 and if it is displays a button  tthat redirects to the admin page
    if(securityCookie == 3){
        var cards = [{CourseName: "View", CourseCode: "Student", FacultyName: "Detailes",code:1},{CourseName: "View", CourseCode: "Course", FacultyName: "Detailes",code:1},{CourseName: "View", CourseCode: "Admin", FacultyName: "Page",code:1},]
    }
    else{
      var cards = [{CourseName: "View", CourseCode: "Student", FacultyName: "Detailes",code:1},{CourseName: "View", CourseCode: "Course", FacultyName: "Detailes",code:1},]
